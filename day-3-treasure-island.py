# This is a "Choose Your Own Adventure" text-based game. It features Input Validation with Flags, if/elif/else statements (and a lot of them...), as well as multiple paths to choose from.
